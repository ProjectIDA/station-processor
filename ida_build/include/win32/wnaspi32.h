#pragma ident "$Id: wnaspi32.h,v 1.1 2005/05/13 17:16:55 dechavez Exp $"
//***************************************************************************
//
// Name:    WNASPI32.H
//
...
typedef DWORD (FAR  SENDASPI32COMMAND)(LPSRB);
typedef SENDASPI32COMMAND FAR *LPSENDASPI32COMMAND;

extern LPSENDASPI32COMMAND lpfnSendASPI32Command;
#define SendASPI32Command (*lpfnSendASPI32Command)

typedef DWORD (FAR  GETASPI32SUPPORTINFO)();
typedef GETASPI32SUPPORTINFO FAR *LPGETASPI32SUPPORTINFO;

extern LPGETASPI32SUPPORTINFO lpfnGetASPI32SupportInfo;
#define GetASPI32SupportInfo (*lpfnGetASPI32SupportInfo)
...
typedef struct   {              /* used for sequencial read/write command */
  WORD cmd : 8;
  WORD fixed : 1;
  WORD sili : 1;
  WORD _reserved1 : 3;
 ...
 *
 * $Log: wnaspi32.h,v $
 * Revision 1.1  2005/05/13 17:16:55  dechavez
 * AAP 05-11 update
 *
 * Revision 1.1  2005/02/15 15:15:29  dechavez
 * added
 *
 */
