#pragma ident "$Id: string.c,v 1.27 2009/05/14 16:32:06 dechavez Exp $"
/*======================================================================
 *
 ...
 *
 * $Log: string.c,v $
 * Revision 1.27  2009/05/14 16:32:06  dechavez
 * added support for NULL (mt-unsafe) text buffers in isiTstampsString and isiGenericTsHdrString
 *
