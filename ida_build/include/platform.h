/* $Id: platform.h,v 1.37 2009/03/24 20:53:38 dechavez Exp $ */
/*====================================================================
 *
...
#   define ARM_SLATE
#   define i386     // ARM in LITTLE_ENDIAN mode behaves almost like i386
...
/* added to avoid depricated function call and warning about that */
#if _MSC_VER == 1400
#define read    _read
#define write   _write
#define mkdir   _mkdir
...
#   define THREAD_DETACH(tp)       pthread_detach(tp)
 ...
 *
 * $Log: platform.h,v $
 * Revision 1.37  2009/03/24 20:53:38  dechavez
 * added THREAD_DETACH macro
 *
 * Revision 1.36  2009/01/06 20:43:50  dechavez
 * aap modifications to calm more recent Microsoft compilers
 *
