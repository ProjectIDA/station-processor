#pragma ident "$Id: iacp.h,v 1.14 2008/08/20 18:19:16 dechavez Exp $"
...
#define IACP_MAX_HANDSHAKE_COUNT           5
...
#define IACP_PROTO_IACP 0
#define IACP_PROTO_NRTS 1

#ifndef IACP_DEF_AT_PROTO
#define IACP_DEF_AT_PROTO IACP_PROTO_IACP
#endif
...
BOOL iacpSendNrtsFrame(IACP *iacp, IACP_FRAME *frame);
 ...
 *
 * $Log: iacp.h,v $
 * Revision 1.14  2008/08/20 18:19:16  dechavez
 * added defines and attributes to support legacy NRTS protocol
 *
