#pragma ident "$Id: log.c,v 1.3 2006/02/09 20:01:48 dechavez Exp $"
/*======================================================================
 *
...
static void xfer_LogCnfGen1(int level, struct xfer_cnfgen1 *cnf)
{
int i, j;
...
#ifdef NRTS_SUPPORT
static void xfer_LogCnfNrts(int level, struct xfer_cnfnrts *cnf)
{
int i, j;
...
static void xfer_LogWavGen1(int level, struct xfer_wavgen1 *wav)
{
    CB;
...
#ifdef IDA_SUPPORT
      case XFER_WAVIDA:
        util_log(level, "IDA waveform packet");
        break;
#endif /* IDA_SUPPORT */
