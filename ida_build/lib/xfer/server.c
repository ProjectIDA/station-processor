#pragma ident "$Id: server.c,v 1.13 2006/11/10 06:30:26 dechavez Exp $"
/*======================================================================
 *
...
static long xfer_EncodeChnCnf(start_of_message, info, format)
...
/* Read and store access list */
    ...
    if ((fp = fopen(fname, "r")) == NULL) {
        util_log(2, "%s: %s", fname, syserrmsg(errno));
        util_log(2, "access control disabled");
    }
